...
win.title("Communico:Real-Time Voice🎙️ Translator🔊")
icon = tk.PhotoImage(file="icon.png")
win.iconphoto(False, icon)

#  labels and text boxes for the recognized and translated text
...
#  dropdown menus for the input and output languages
